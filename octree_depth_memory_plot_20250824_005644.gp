...
# Data file: octree_depth_memory_analysis_20250824_005644.csv
...
plot 'octree_depth_memory_analysis_20250824_005644.csv' using ($5):($6) every ::1 title 'All Points' with points pt 6 ps 0.8 lc rgb 'gray', \
     '<(grep "Clustered" octree_depth_memory_analysis_20250824_005644.csv)' using 5:6 title 'Clustered Strategy' with points ls 1, \
     '<(grep "Linear" octree_depth_memory_analysis_20250824_005644.csv)' using 5:6 title 'Linear Strategy' with points ls 2, \
     '<(grep "Controlled" octree_depth_memory_analysis_20250824_005644.csv)' using 5:6 title 'Controlled Strategy' with points ls 3, \
     '<(grep "Density" octree_depth_memory_analysis_20250824_005644.csv)' using 5:6 title 'Density Strategy' with points ls 4

# Add trend line for clustered data (highest correlation)
f(x) = a*x + b
fit f(x) '<(grep "Clustered" octree_depth_memory_analysis_20250824_005644.csv)' using 5:(log($6)) via a, b
set samples 100
...
plot 'octree_depth_memory_analysis_20250824_005644.csv' using ($5):($8) every ::1 title 'All Points' with points pt 6 ps 0.8 lc rgb 'gray', \
     '<(grep "Clustered" octree_depth_memory_analysis_20250824_005644.csv)' using 5:8 title 'Clustered Strategy' with points ls 1, \
     '<(grep "Linear" octree_depth_memory_analysis_20250824_005644.csv)' using 5:8 title 'Linear Strategy' with points ls 2, \
     '<(grep "Controlled" octree_depth_memory_analysis_20250824_005644.csv)' using 5:8 title 'Controlled Strategy' with points ls 3, \
     '<(grep "Density" octree_depth_memory_analysis_20250824_005644.csv)' using 5:8 title 'Density Strategy' with points ls 4
...
splot 'octree_depth_memory_analysis_20250824_005644.csv' using 5:4:6 every ::1 title 'Memory Usage' with points pt 7 ps 1.5
...
plot 'octree_depth_memory_analysis_20250824_005644.csv' using 5:(1.0) every ::1 smooth frequency
unset table
